...
// /**
//  * ExtApiCarouselCardModal component displays job details in a modal.
...
//           <Modal.Title>
//             <h3>
//               {job.title.slice(0, CharLimitTitleModal) +
//                 (job.title.length > CharLimitTitleModal ? "..." : "")}
//             </h3>
//           </Modal.Title>
//         </Modal.Header>
//         <Modal.Body>
...
//             {job.description.slice(0, CharLimitDescriptionModal) +
//               (job.description.length > CharLimitDescriptionModal ? "..." : "")}
//           </p>
//           <p>
//             <HiOutlineLocationMarker /> <strong>Location:</strong>{" "}
...
//             {job.company.display_name.slice(0, CharLimitCompanyModal) +
...
//                 You should be logged in to contact this company.
//               </Button>
//             )}
//           </div>
//         </Modal.Body>
