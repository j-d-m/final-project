    ...
    <div className="jobs-carousel">
      <div className="carousel-wrapper">
        <Carousel breakPoints={breakPoints}>
          ...
          <h5> {(job.title).slice(0, charLimitTitle) + ((job.title).length > charLimitTitle ? "..." : "")}</h5>
        ...
        <p>by <strong> {(job.company.display_name).slice(0, charLimitCompany) + ((job.company.display_name).length > charLimitCompany ? "..." : "")} </strong></p>
